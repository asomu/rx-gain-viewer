...
urlpatterns = [
    ...
    path('session/update/<int:session_id>/', views.update_session, name='update_session'),
    ...
    path('api/export-full-report-ppt/<int:session_id>/', views.export_full_report_ppt, name='export_full_report_ppt'),
